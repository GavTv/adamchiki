...
const Contacts = () => {
  return (
    <Layout>
      <SEO
        title="Контакты"
        description="Контакты салона красоты Новобьюти. Адрес: Москва, ул. Новослободская, д. 3, 3 этаж. Телефон: +7 (985) 053-47-61. Режим работы и схема проезда."
      ...
      <div className="container py-12 md:py-20">
        ...
        <AnimatedSection className="max-w-2xl mx-auto text-center mb-12">
          ...
          >
            ...
            <p>
              Мы рады пригласить Вас в салон красоты "Новобьюти"! Салон находится в 2х минутах от ст.метро Новослободская.
