...
const bodyServices = [
  ...
  { name: "SMAS лифтинг по телу (1 зона)", price: "9000 ₽" },
...
const LPGMassage = () => {
  return (
    <Layout>
      <SEO
        title="LPG массаж"
        description="LPG массаж в Новобьюти: коррекция фигуры, антицеллюлитный массаж, лимфодренаж. Видимый результат после первых процедур. Цены от 1000 ₽."
