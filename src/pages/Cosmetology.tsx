...
const Cosmetology = () => {
  return (
    <Layout>
      <SEO
        title="Косметология"
        description="Косметологические услуги в Новобьюти: пилинги, чистка лица, мезотерапия, биоревитализация, уходы Ultraceuticals. Запись к косметологу."
